  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 footer-contact">
            ...
            <p>
              Av. el Romeral <br>
              125, 24191 Villabalter, León<br>
              España <br><br>
              <strong>Tel:</strong> 666555444<br>
              <strong>Email:</strong> hola@greenlife.com<br>
            </p>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>GreenLife</span></strong>. Todos los derechos reservados
        </div>
      </div>
    </div>
  </footer>
